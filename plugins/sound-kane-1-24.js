...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: 'www.instagram.com/zens_nation',
    mediaType: 2, 
    description: 'www.instagram.com/zens_nation',
    title: "Now Playing...",
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/eade7a4754360f2abd827.jpg')).buffer(),
    sourceUrl: 'www.instagram.com/zens_nation'
 	  }
     }
    })
}
